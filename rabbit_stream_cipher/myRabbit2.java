...
public class myRabbit2{
	public static void main(String[] args){
		...
		boolean trimPadding = false;		
		final byte[] encryptedMessage = rabbit.encryptMessage(message, key, IV,addPadding);
		String str = new String(encryptedMessage,StandardCharsets.UTF_8);
		System.out.println(str);
		final String decryptedString = rabbit.decryptMessage(encryptedMessage,key, IV, trimPadding);
